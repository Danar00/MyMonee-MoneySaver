...
//        let homeViewController = HomeViewController(nibName: String(describing: HomeViewController.self), bundle: nil)
        let mainTabController = MainTabController(nibName: String(describing: MainTabController.self), bundle: nil)
        
//        mainViewController.title = "Home"
//        mainTabController.title = "Home"
    ...
    /*
     ...
     window?.rootViewController = MainController(nibName: "MainController", bundle: nil)
     window?.makeKeyAndVisible()
     */
